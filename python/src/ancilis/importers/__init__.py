"""Ancilis evidence importers — AWS CloudTrail, GCP Cloud Audit, GitHub audit log, GitLab audit events, Jira audit records, SARIF, CycloneDX, Braintrust, Browserbase, Chroma, Composio, Datadog LLM, Deepgram, ElevenLabs, Helicone, Honeycomb, LangSmith, Langfuse, LiteLLM, Logfire, MCP registry, n8n, OpenRouter, OTel GenAI, Pinecone, Portkey, Qdrant, SendGrid, Sentry, Snyk, Stripe, Twilio, Weaviate, and W&B Weave ingestion."""
